    ...
    try {
        ...
        if (data) {
            ...
            if (addUser) {
                ...
                yield eventEmitter_1.default.sendToSocket(userData.socketId, singUpData);
                ...
                if (tableData && tableData.activePlayer == tableData.maxPlayer) {
                    ...
                    yield eventEmitter_1.default.sendToRoom(tableData._id, validateUserData);
                    ...
                    yield eventEmitter_1.default.sendToRoom(tableData._id, validateRoundTimerData);
                    let delayGameData = {
                        jobId: tableData._id,
                        attempts: 1,
                    ...
                    (0, bull_1.delayGame)(delayGameData);
                }
                else {
                    let tableData = yield (0, defaultFormat_1.setTable)(userData, userData._id);
